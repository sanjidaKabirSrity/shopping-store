...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `
      <div class="card h-100 single-product border-0 bg-white">
        ...
        <div class = "text-center">
          <span class="text-danger">Rating: ${product.rating.rate}</span>
          <span class = "text-muted">Viewers: ${product.rating.count}</span>
        </div>
        ...
        <button id="details-btn" class="btn text-white">Details</button>
        </div>
      </div>
    `;
    /*
    ...
    <div class="single-product">
      ...
      <div class="products-info">
        ...
        <div>
        <span>Category: ${product.rating.rate}</span>
        <span>Catego: ${product.rating.count}</span>
        </div>
        <div>
      ...
      <div class="products-info">
        ...
        <div class="rated-section">
          <span><b>Rating Count : </b>  ${product.rating.count}</span>
          <span><b>Rating rate : </b> ${product.rating.rate}</span>
        </div>
        <h2>Price: $ ${product.price}</h2>
        <div class="buttons">
            <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn btn-success">add to cart</button>
